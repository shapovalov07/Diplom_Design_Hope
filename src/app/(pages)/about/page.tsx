                    ...
                    <div className="">
                        <div className="flex gap-[3%] mb-20">
                            ...
                            <div className="w-[340px]">
                                <div>
                                    <img src="/вб.png" alt="" />
                                    <div className="flex h-[40px] bg-red-700 items-center mb-[18px] pl-3 sm:pl-4">
                                        <p className="text-white text-[14px] sm:text-[19px] leading-none uppercase whitespace-nowrap">менеджер проектов</p>
                                    </div>
                                </div> 
                                <div>
